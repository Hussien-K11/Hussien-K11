...
| 1     | Log Analysis & Detection Logic         | [Log File Analysis](https://github.com/Hussien-K11/log-file-analysis) | ✅ Complete    |
| 2     | Threat Intelligence & Profiling        | [APT29 Threat Actor Profile](https://github.com/Hussien-K11/APT29-Threat-Actor-Profile) | 🚧 In Progress |
| 3     | SIEM Triage & Alerting Rules           | [Splunk Cloud Simulation](https://github.com/Hussien-K11/Simple-SIEM-Simulation) | 🚧 In Progress |
| 4     | Phishing Alert Investigation           | Phishing Email Manual Analysis *(Planned)*              | 🔜 Planned     |
| 5     | Incident Response & Documentation      | [IR Policy Review](https://github.com/Hussien-K11/Incident-Response-Policy-Review), IR Playbook *(Planned)* | 🔜 Planned     |
...
## 4. Learning Path & Certifications
